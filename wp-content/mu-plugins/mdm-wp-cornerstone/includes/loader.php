...
class Loader extends \Mdm\Wp\Cornerstone\Common\Singleton {
	...
	public function register( $object ) {
		// Register Actions
		if ( $object instanceof \Mdm\Wp\Cornerstone\Interfaces\Action_Hook_Subscriber ) {
			$this->register_actions( $object );
		}
		// Register Filters
		if ( $object instanceof \Mdm\Wp\Cornerstone\Interfaces\Filter_Hook_Subscriber ) {
			$this->register_filters( $object );
		}
		// Register Shortcodes
		if ( $object instanceof \Mdm\Wp\Cornerstone\Interfaces\Shortcode_Hook_Subscriber ) {
	 ...
	 */
	private function register_action( \Mdm\Wp\Cornerstone\Interfaces\Action_Hook_Subscriber $object, $name, $parameters ) {
	 ...
	 */
	private function register_actions( \Mdm\Wp\Cornerstone\Interfaces\Action_Hook_Subscriber $object ) {
	 ...
	 * @param mixed                           $parameters
	 */
	private function register_filter( \Mdm\Wp\Cornerstone\Interfaces\Filter_Hook_Subscriber $object, $name, $parameters ) {
	 ...
	 * @param Filter_Hook_SubscriberInterface $object
	 */
	private function register_filters( \Mdm\Wp\Cornerstone\Interfaces\Filter_Hook_Subscriber $object) {
	 ...
	 * @param mixed                           $parameters
	 */
	private function register_shortcode( \Mdm\Wp\Cornerstone\Interfaces\Shortcode_Hook_Subscriber $object, $name, $parameters ) {
		if( is_string( $parameters )) {
	 ...
	 * @param Shortcode_Hook_SubscriberInterface $object
	 */
	private function register_shortcodes( \Mdm\Wp\Cornerstone\Interfaces\Shortcode_Hook_Subscriber $object) {
