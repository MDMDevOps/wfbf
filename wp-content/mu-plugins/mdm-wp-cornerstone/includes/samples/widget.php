...
namespace Mdm\Wp\Cornerstone\Widgets;
...
class Sample extends \WP_Widget {
	...
	public function __construct() {
		...
		$this->widget_id_base = 'mdm_wp_cornerstone_widget_id';
		$this->widget_name    = 'Sample Widget Display name';
		$this->widget_options = array(
			'classname'   => 'mdm_wp_cornerstone_widget_class',
			'description' => 'Sample Widget Display Description' );
		// Construct parent
	...
	public function form( $instance ) {
		...
		include plugin_dir_path( mdm_wp_cornerstone_get_plugin_file() ) . 'partials/forms/widget.php';
	}
