...
class Taxonomies extends \Mdm\Wp\Cornerstone\Common\Plugin implements \Mdm\Wp\Cornerstone\Interfaces\Action_Hook_Subscriber {
	...
	public static function add_taxonomies() {
		...
		foreach( $taxonomies as $taxonomy ) {
			...
			$class = '\\Mdm\\Wp\\Cornerstone\\Taxonomies\\' . $taxonomy;
